...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        self.cost = tf.reduce_mean(symbf.huber_loss(target - pred_action_value) + 
                                 tf.nn.softmax_cross_entropy_with_logits(labels=action_o_one_hot, 
                                                                        logits=pi_value), name='cost')

...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        pi_cost = self.lamb * (tf.nn.softmax_cross_entropy_with_logits(labels=action_o_one_hot, logits=pi_value[0])
                            + tf.nn.softmax_cross_entropy_with_logits(labels=action_onehot, logits=pi_value[1]))
        ...
        #pred = tf.argmax(pi_value[0], axis=1)

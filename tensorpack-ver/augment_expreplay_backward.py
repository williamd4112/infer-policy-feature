...
class AugmentReplayMemory(ReplayMemory):
    def __init__(self, max_size, state_shape, history_len):
        ...
        self.old_action_o = np.zeros((self.max_size,), dtype='int32')
    ...
    def sample(self, idx):
        ...
        if idx + k <= self._curr_size:
            ...
            old_action_o = self.old_action_o[idx: idx + k]
        else:
            ...
            old_action_o = self._slice(self.old_action_o, idx, end)
    ...
    def _assign(self, pos, exp):
        ...
        self.old_action_o[pos] = exp.old_action_o
...
class AugmentExpReplay(ExpReplay, Callback):
    ...
    def _populate_exp(self):
        ...
        old_action_o = self.player.get_internal_state()['opponent_action']
        ...
        self.mem.append(AugmentExperience(old_s, act, reward, isOver, action_o, old_action_o))
    ...
    def _process_batch(self, batch_exp):
        ...
        old_action_o = np.asarray([e[5] for e in batch_exp], dtype='int8')
        return [state, action, reward, isOver, action_o, old_action_o]

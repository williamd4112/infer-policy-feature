...
class ReplayMemory(object):
    ...
    def sample(self, idx):
        ...
        # TODO: modify history len to trace len
        ...
        # since pad_sample, we won't concern about one trace containing state in the other episodes
    ...
    def _pad_sample(self, state, reward, action, isOver):
        ...
        return (state, reward[:-1], action[:-1], isOver[:-1])

    ...
    def _get_DQN_prediction(self, image):
        ...
        with argscope(Conv2D, nl=PReLU.symbolic_function, use_bias=True), \
            ...
            l = (LinearWrap(image)
                 ...
                 .Conv2D('conv1', out_channel=32, kernel_shape=8, stride=4)
                 .Conv2D('conv2', out_channel=64, kernel_shape=4, stride=2)
                 .Conv2D('conv3', out_channel=64, kernel_shape=4, stride=2)
                 .Conv2D('conv4', out_channel=64, kernel_shape=3)
                 .Conv2D('conv5', out_channel=64, kernel_shape=3)
...
if __name__ == '__main__':
    ...
    if args.task != 'train':
        ...
        logger.set_logger_dir(
            os.path.join('train_log', 'DQN-deep-skip-{}-ai_skip-{}-field-{}-hist-{}-batch-{}-lr-{}-{}'.format(

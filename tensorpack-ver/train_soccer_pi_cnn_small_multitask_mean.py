...
from DQNPIModel_multitask_mean import Model as DQNModel
import common
    ...
    def _get_DQN_prediction(self, image):
        ...
        with tf.variable_scope('pi'):
            ...
            for i in range(self.num_agents):
                pi_ys.append(FullyConnected('fct-%d' % i, pi_h, self.num_actions, nl=tf.identity))
...
if __name__ == '__main__':
    ...
    if args.task != 'train':
        ...
        logger.set_logger_dir(
            os.path.join('train_log', 'MT-mean-DQNPI-small-field-{}-skip-{}-ai_skip-{}-hist-{}-batch-{}-lr-{}-lamb-{}-{}'.format(

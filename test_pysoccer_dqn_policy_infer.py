...
from dqn_policy_infer import DeepPolicyInferQNetwork
...
def main(args):
    ...
    logger.info('Initialize model with [state_shape = %s, num_action = %d] ... ' % (dqn_state_shape, env.get_num_action()))
    model = DeepPolicyInferQNetwork(name='DPIQN', 
                    reuse=False, 
